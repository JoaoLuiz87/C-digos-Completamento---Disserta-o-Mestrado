#TESTE 2 DE RECONSTRUÇÃO DE IMAGENS COM TTWOPT-V2
...
for imagem in figs
	if imagem == "peppers"
		...
		for i=1:b
			...
			Z = inverse_mapping(Z)
			save("recover2_ttv2_$imagem$i.pdf",colorview(RGB, permuteddimsview(Z, (3, 1, 2))))
		end
...
CSV.write("erros_teste9_ttv2.csv",df1)
CSV.write("psnr_teste9_ttv2.csv",df2)
CSV.write("tempos_teste9_ttv2.csv",df3)
println("postos-TT:")
println("peppers...")
